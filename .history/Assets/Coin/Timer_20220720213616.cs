...
public class Timer : MonoBehaviour
{
    ...
    */
    ...
    {
        /*
         deltaTime stands for the time that has passed between the render of the current frame from the previous frame
         i.e deltaTime is the lapse of time between our current frame and our previous frame.
         If frame1 renders, 3.5 seconds pass and frame2 rende
        */
