...
{
    /* 
        static means that only one of copy of the variable will be created for all instances. Hence, whatever changes to the variable are made by one instance will be applied
        ...
        */
        if(otherCollider.CompareTag("Player") == true)
        {
            ...
            if(Coin.coinsCounter > 0){
                ...
                Debug.Log("All coins have been picked up. Game over.");
            }
