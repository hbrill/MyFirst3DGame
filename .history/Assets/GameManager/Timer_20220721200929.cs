    ...
    */
    ...
    void Update()
    {
        ...
        */
        ...
        /* It is impossible for deltaTime to get exactly to 0, so with our if statement we set our 
        condition to be once the countdown has gotten to 0 or under
        */
        if(countdown <= 0){
            Debug.Log("You're out of time. Game over!");
            // at this point we'd want to restart the level. So we bring the coin counter back to 0
            Coin.coinsCounter = 0;
